...
DATA DIVISION.
    ...
    *> I hate that this is required...
    ...
    01 RANDOM-FLT PIC S9(4)V9(5) COMP.
...
PROCEDURE DIVISION.
    ...
    *> Generates a single random positive integer, always between 0 and RANDOM-THRESH.
    GENERATE-RANDOM-INT.
    MOVE FUNCTION RANDOM() TO RANDOM-FLT.
    IF RANDOM-FLT < 0 THEN
        MULTIPLY RANDOM-FLT BY MINUS-ONE GIVING RANDOM-FLT
    END-IF.
    MULTIPLY RANDOM-FLT BY RANDOM-THRESH GIVING RANDOM-FLT.
    MOVE FUNCTION INTEGER(RANDOM-FLT) TO RANDOM-INT.
